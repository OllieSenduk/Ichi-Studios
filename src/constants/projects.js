const projectLogos = [
	{
		title: 'Depotlab',
		imgUrl: 'https://i.imgur.com/cOPzNdc.jpg',
		project: false
	},
	{
	...
	{
		title: 'Draw Static',
		shortDescription: 'Ruby on Rails gem to clean up your static routes.',
		imgUrl: 'https://i.imgur.com/XhgcIJE.png',
		openSource: true,
		project: false
	},
	{
		title: 'Fetch Snippets',
		imgUrl: 'https://i.imgur.com/k2T3WYe.png',
		openSource: true,
		project: false,
		shortDescription:
			'a CLI interface and API that stores code templates and writes them on command to the current file directory'
	}
];
