...
export default {
    ...
    methods: {
        ...
        //     }
            ...
            const currentLeft = currentPage.$el.querySelector(".project__hero__image-left");
            const currentRight = currentPage.$el.querySelector(".project__hero__image-right");
            ...
            const nextRight = nextPage.$el.querySelector(".project__hero__image-right");
            ...
            .to(pagesContainer, 0.3, { backgroundImage: context.projects[context.pageNum].background })
    ...
    destroyed () {
        window.removeEventListener("wheel", this.throttle(this.updateSlideNum, 1500));
        window.removeEventListener("touch", this.throttle(this.updateSlideNum, 1500));
    },
    data () {
        return {
            tl: new TimelineMax({}),
