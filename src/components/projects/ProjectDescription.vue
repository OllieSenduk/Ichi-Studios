<template>
  <div>
    ...
    <div class="project-page__content">
      ...
      <div class="link">
        <button type="button" @click="close">CLOSE>VISIT NOW</button>
      </div>
    </div>
    <div class="img">
      <img src="https://i.imgur.com/hdv10gF.png" alt />
    </div>
    <div class="media">
      <ul>
        <li>
...
.temp {
  ...
  width: 100%;
  height: 100vh;
  background: url("https://i.imgur.com/FA4EpSW.gif") no-repeat 50% 50%;
