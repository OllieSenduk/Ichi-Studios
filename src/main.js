		...
		state: {
			...
			icons: {
				homeIcons: {
					...
					textFour: "Let's get in touch to discuss your ideas and see if we're a fit!"
				}
			},
			projects: [
				{
					...
					information: {
						client: 'Table Vibe',
						categories: [ 'technical delivery', 'startup', 'project management' ]
					},
				...
				},
				{
					...
					information: {
						client: 'IKEA',
						categories: [ 'technical delivery', 'corporate', 'project management' ]
					},
					...
					summary: "Creating 5 proof of concept applications that capture IKEA's values & goals.",
					solution:
				...
				},
				{
					...
					summary: 'Help the everyday person find the legal support they deserve!',
					solution:
				...
				},
				{
					...
					problem: 'The hospitality industry needs more qualified flexible workers.',
					summary: 'The platform for freelancers looking for work in the hospitality industry.',
					solution:
				...
				},
				{
					...
					summary: 'Automating our trades in the volatile cryptocurrency market.',
					solution:
				...
				},
				{
					...
					summary: 'An event to bring together creative Barcelona.',
					solution:
